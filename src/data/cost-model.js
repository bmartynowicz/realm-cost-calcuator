...
const sourceNotes = {
    ...
    salesforce: 'Pricing tied to Enterprise edition event delivery. Monitor for API entitlement updates.',
...
export const sources = [
    ...
    },
    {
        ...
        freeTier: {
            includedEventsPerMonth: 1500000,
...
export const estimateCosts = ({ source, destination, dailyEvents, }) => {
    ...
    const realmTotal = millions * (realmRatePerMillion + REALM_PLATFORM_FEE_PER_MILLION);
...
export const getIntegrationById = (list, id) => {
